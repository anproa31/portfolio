          ...
          <Container.Inner>
            <div className="flex flex-col items-center justify-between gap-8 sm:flex-row">
              <div className="hidden gap-6 text-sm font-medium text-zinc-800 dark:text-zinc-200 md:flex">
                <NavLink href="https://twitter.com/BuiiiAn">Twitter</NavLink>
                <NavLink href="https://github.com/anproa31">GitHub</NavLink>
                <NavLink href="https://www.linkedin.com/in/bui-an/">
                  LinkedIn
                </NavLink>
                <NavLink href="mailto:anbuiii37@gmail.com">Mail</NavLink>
              </div>
              ...
              <p className="text-sm text-zinc-400 dark:text-zinc-500">
                &copy; {new Date().getFullYear()} An Bui Quoc. All rights
                reserved.
              </p>
            </div>
          </Container.Inner>
